...
public class ShutterButton extends View {
    ...
    private void init() {
        ...
        // 设置外圆背景颜色
        mOuterBackgroundColor = getResources().getColor(R.color.blanchedalmond);
        // 设置内圆背景
        mInnerBackgroundColor = getResources().getColor(R.color.blueviolet);
        ...
        // 设置进度条颜色
        mOuterStrokeColor = getResources().getColor(R.color.greenyellow);
        // 设置进度条宽度
