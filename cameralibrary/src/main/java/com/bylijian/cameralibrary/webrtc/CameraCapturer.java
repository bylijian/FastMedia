            ...
            new CameraSession.CreateSessionCallback() {
                ...
                public void onDone(CameraSession session) {
                    ...
                    synchronized (stateLock) {
                        capturerObserver.onCapturerStarted(true /* success */, session.getPreviewSize(), session.getCameraCharacteristics());
                ...
                public void onFailure(CameraSession.FailureType failureType, String error) {
                    ...
                    uiThreadHandler.removeCallbacks(openCameraTimeoutRunnable);
                    synchronized (stateLock) {
                        capturerObserver.onCapturerStarted(false /* success */, null, null);
    ...
    public void setZoom(int zoom) {
        if (currentSession instanceof Camera1Session) {
            ...
            if (currentTime - nextZoomTime > 200) {
                ...
                //华为的傻逼摄像头，连续设置会卡死，就算加了间隔也不能完全解决
